...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Configuraciones.findAll", query = "SELECT c FROM Configuracion c"),
    @NamedQuery(name = "Configuraciones.findByIdConfiguraciones", query = "SELECT c FROM Configuracion c WHERE c.idConfiguraciones = :idConfiguraciones"),
    @NamedQuery(name = "Configuraciones.findByNombre", query = "SELECT c FROM Configuracion c WHERE c.nombre = :nombre"),
    @NamedQuery(name = "Configuraciones.findByValor", query = "SELECT c FROM Configuracion c WHERE c.valor = :valor")})
public class Configuracion implements Serializable {
    ...
    public String toString() {
        return "com.invbf.adminclientesapi.entity.Configuraciones[ idConfiguraciones=" + idConfiguraciones + " ]";
    }
